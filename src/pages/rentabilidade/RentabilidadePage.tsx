...
export function RentabilidadePage() {
    ...
    async function loadRentabilidadeData() {
        setLoading(true)
        try {
            // Get Rentabilidade pillar
            ...
            console.error('Error loading rentabilidade data:', error)
        } finally {
            setLoading(false)
        }
    }
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">Rentabilidade</h1>
                    </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-16">
                    <p className="text-[var(--color-text-muted)]">
                        Nenhum Key Result de Rentabilidade encontrado para {selectedUnitName}.
                    </p>
